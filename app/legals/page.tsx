...
export default function Legals() {
    return (
        ...
        <section className="cookies">
            ...
            <p>La Commission Nationale de l'Informatique et des Libertés (CNIL) définit un cookie comme « une information déposée sur votre disque dur par le serveur du site que vous visitez ». Il contient le nom du serveur qui l'a déposée, un identifiant unique et éventuellement une date d'expiration. Ces informations sont stockées sur votre ordinateur dans un simple fichier texte auquel le serveur peut accéder pour lire ou enregistrer des informations.</p>
